...
def comparison(list1, list2, list3, list4):
    x12 = sum(list1[0], list2[0])
    x34 = sum(list3[0], list4[0])
    y12 = sum(list1[1], list2[1])
    y34 = sum(list1[0], list4[1])
    return (x12 == x34 and y12 == y34)
'''
A1 = [1, 2]
A2 = [2, 1]
A3 = (4, 3)
...
if comparison(A1, A2, A3, A4):
    print('В задаче участвуют координаты ПАРАЛЛЕЛОГРАММА. Поздравляем')
else:
    print('Хотелось очень, но нет. Это точно не параллелограмм')
